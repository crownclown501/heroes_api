// heroes-app\src\app\heroes\dc\detalles\detalles.component.ts
...
import dcRivals from '../../../core/json/cd_rivals.json';
...
export class DetallesComponent {
  ...
  // Asignamos el JSON
  private rivalsMap: { [heroName: string]: string[] } = dcRivals;
  ...
  loadRivals() {
    ...
    forkJoin(rivalObservables).subscribe(resultsArrays => {
      const rivalsFound: Hero[] = [];
        ...
        //en caso de que solo querramos agregar uno y no la cantidad de rivales
